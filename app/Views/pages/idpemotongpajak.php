                ...
                <div class="card-body p-5">
                    ...
                    <form action="<?= base_url("pemotong-pajak/update/{$id}"); ?>" method="post">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control p-0" id="npwp" name="npwp" pattern="[0-9]+" title="Hanya angka yang diperbolehkan" required value="<?= old('npwp', $record ? $record['npwp'] : ''); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="input" class="col-sm-2 col-form-label">Nama Instansi Pemerintah</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control p-0" id="nama_instansi" name="nama_instansi" value="<?= old('nama_instansi', $record ? $record['nama_instansi'] : ''); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="input" class="col-sm-2 col-form-label">ID Subunit Organisasi</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control p-0" id="id_sub_unit" name="id_sub_unit" value="<?= old('id_sub_unit', $record ? $record['id_sub_unit'] : ''); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control p-0" id="nama_penandatangan" name="nama_penandatangan" value="<?= old('nama_penandatangan', $record ? $record['nama_penandatangan'] : ''); ?>">
                            </div>
                        </div>
